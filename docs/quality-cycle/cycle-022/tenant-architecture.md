...
T1 only creates the foundation and root backfill. T2 binds authentication/session/request context to tenant membership. T3/T4 migrate tenant-owned data. T5 propagates runtime context. T6 finishes live Admin control plane.
