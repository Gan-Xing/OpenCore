...
| ---------------------------------- | -------- | -------- | --------------- | --------------- | -------------- | ------- | ----------- | ------------ | ---------------- | ------------------ | ------------------- | ------------ | -------------- | ------ |
| System Roles Admin live-only       | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None.          | Meets  |
| System Users Admin live-only       | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None.          | Meets  |
| System Config Admin live-only      | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None.          | Meets  |
| System Notices Admin live-only     | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None.          | Meets  |
