...
| System Files Admin live-only       | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None for this row; unified seven-page guard remains a separate queue item. | Meets  |
| System Permissions Admin live-only | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None for this row; unified seven-page guard remains a separate queue item. | Meets  |
| System Posts Admin live-only       | yes      | yes      | yes             | yes             | yes            | yes     | yes         | yes          | yes              | yes                | yes                 | yes          | None for this row; unified seven-page guard remains a separate queue item. | Meets  |
