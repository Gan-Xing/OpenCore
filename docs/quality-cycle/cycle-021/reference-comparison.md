...
| System Permissions | System permission catalog                      | live                | live-only                    | yes       | pending          | pending            | no               | Confirm closure-flow public smoke and global guard.         |
| System Posts       | System post management                         | live                | live-only                    | yes       | pending          | pending            | no               | Confirm closure-flow public smoke and global guard.         |
