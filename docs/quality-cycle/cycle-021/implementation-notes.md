...
- Admin fallback closure runner: `tools/scripts/admin-fallback-closure-guard.ts`
- System Admin live-only guard manifest:
  `tools/guards/system-admin-live-only.guard.json`
