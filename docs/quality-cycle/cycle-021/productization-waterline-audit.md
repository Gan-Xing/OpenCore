...
| ------------------------------------------- | --------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1/55                                        | `core.notice`         | First loop, enhance     | Management CRUD is live, and Round 55 adds persisted per-user read receipts, authenticated inbox list/detail/unread-count/unread-list/mark-read/mark-all-read APIs, SDK/OpenAPI coverage, an Admin Inbox tab and a header unread badge. Delivery adapter design, notification templates, WebSocket/mail/SMS fan-out and any read-user analytics remain below a full notice product.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
2. `core.login-log`: Round 26 completed browser/OS parsing and server-side
   ...
   pollution from internal role/user session invalidation. Remaining login-log
   work is IP/location enrichment where feasible, broader mobile/social login
   logging stages and any future structured actor/reason fields for logout
   records.
...
4. `core.notice`: Round 55 completed persisted per-user read/unread state,
   ...
   fixed/deploy/public smoke. Remaining notice work is delivery adapter design,
   notification templates, any admitted WebSocket/mail/SMS fan-out and
   read-user analytics before claiming full notice-product depth.
