...
| 9/24/37                               | `core.config`         | First loop, enhance     | Config CRUD and secret redaction are live. Round 24 adds public value-by-key reading, service value-cache refresh and mutation invalidation. Round 37 adds category/name/remark metadata across Prisma/API/SDK/Admin/export/smoke while preserving secret redaction and cache behavior. Batch/file export depth and broader runtime propagation boundaries remain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
2. `core.config`: Round 24 completed public get-value-by-key plus cache
   ...
   across Prisma/API/SDK/Admin/export/smoke. Remaining config work is
