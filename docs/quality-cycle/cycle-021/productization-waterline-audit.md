...
4. `core.notice`: Round 55 completed persisted per-user read/unread state,
   ...
   template across API/SDK/Admin/OpenAPI/fixed/deploy/public smoke. Remaining
   notice work is delivery adapter design and any admitted WebSocket/mail/SMS
   fan-out before claiming full notice-product depth.
