...
1. `core.user`: Round 19 completed user status/reset-password flows and direct
   ...
   public preview, replacement and deletion backed by file storage. Remaining
   user work is import/export and batch workflows.
