...
1. `core.config`: Round 24 completed public get-value-by-key plus cache
   ...
   and stale Config bundle checks. Remaining config foundation work is advanced
