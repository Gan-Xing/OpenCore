...
1. `core.config`: Round 24 completed public get-value-by-key plus cache
   ...
   propagation loop for Admin title through `config/runtime`. Remaining config
