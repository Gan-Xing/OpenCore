...
2. `core.login-log`: Round 26 completed browser/OS parsing and server-side
   ...
   coverage. Remaining login-log work is IP/location enrichment where feasible,
