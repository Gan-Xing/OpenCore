...
1. `core.user`: Round 19 completed user status/reset-password flows and direct
   ...
   `core:user:import` permission across registry/API/Admin/smoke. Remaining
   user work is native XLSX/binary Excel import/export depth and any dedicated
