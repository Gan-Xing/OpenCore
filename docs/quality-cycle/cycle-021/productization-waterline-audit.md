...
1. `core.user`: Round 19 completed user status/reset-password flows and direct
   ...
   Remaining user work is Excel import/export and any dedicated User-page role
