...
2. `core.config`: Round 24 completed public get-value-by-key plus cache
   ...
   export payload plus Admin download and smoke guards. Remaining config work
   is batch deletion and broader runtime propagation boundaries.
