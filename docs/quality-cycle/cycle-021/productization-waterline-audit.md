...
1. `core.user`: Round 19 completed user status/reset-password flows and direct
   ...
   update-existing session revocation. Remaining user work is native
   XLSX/binary Excel import/export depth, a dedicated import permission if
   admitted and any dedicated User-page role assignment workflow if admitted.
