...
本目录保存 OpenCore（开元）的架构、模块、开发、runtime、部署、handoff、quality cycle 和 AI Native 文档。当前事实不是停在 S3-S9/BE20：OpenCore 已完成 S3-S9、runtime integration、OpenForge V1、Quality Cycle 001、Backend Self-Loop BE20、Admin Pro V6 迁移，以及 Cycle-021 的有限 System Admin fallback closure。

## 当前事实

| 主题                | 当前状态                                                                                                                         | 主文档                                                                                                                 |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| 项目进度索引        | Cycle-021 已完成 126 个 runtime/guard 阶段和 Round 127 docs-only reconciliation；七个 System Admin fallback closure 项均已 Meets | [strategy/progress.md](strategy/progress.md)                                                                           |
...
| 若依/芋道能力矩阵   | 只做能力归属、优先级和准入边界，不替代 Cycle-021 验收矩阵                                                                        | [strategy/ruoyi-yudao-capability-matrix.md](strategy/ruoyi-yudao-capability-matrix.md)                                 |
...
5. [Cycle-021 handoff](quality-cycle/cycle-021/handoff.md)
6. [Cycle-021 acceptance matrix](quality-cycle/cycle-021/acceptance-matrix.md)
7. [产品化水位审计](quality-cycle/cycle-021/productization-waterline-audit.md)
8. [开发起步](development/getting-started.md)
9. [本地部署 runbook](deployment/opencore-local-deploy.md)
10. [Release readiness](deployment/opencore-release-readiness.md)
...
| Quality  | [Cycle-021 Handoff](quality-cycle/cycle-021/handoff.md)、[Acceptance Matrix](quality-cycle/cycle-021/acceptance-matrix.md)、[Waterline Audit](quality-cycle/cycle-021/productization-waterline-audit.md)、[Backlog](quality-cycle/cycle-021/backlog.md)、[Round History](quality-cycle/cycle-021/round-history.md)、[Quality Ledger](quality-cycle/ledger.md) |
| AI       | [AI Native 路线图](ai/ai-native-roadmap.md)                                                                                                                                                                                                                                                                                                                   |

## 当前边界

已完成的基础平台能力包括 S3-S9、runtime integration R-1-R7、OpenForge V1 A-L、Quality Cycle 001、Backend Self-Loop BE20、Admin Pro V6 迁移和 Cycle-021 System Admin fallback closure。基础后台能力已经按 OpenCore 的 package-owned runtime、typed SDK、Admin live-only、OpenAPI、smoke 和 deploy guard 口径验收。

仍需显式准入的大域：CRM、ERP、MES、WMS、mall、member、真实支付/退款/对账、生产多租户、BPMN/full workflow、完整报表设计器、大数据异步导出、AI/RAG/Agent、OpenForge 直接写 Prisma schema/migration/business code。
