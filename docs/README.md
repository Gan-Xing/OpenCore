...
| Handoff  | [Handoff 索引](handoff/README.md)、[S3-S8 Implementation Handoff](handoff/2026-06-10-s3-s8-implementation-handoff.md)、[Runtime Integration Handoff](handoff/2026-06-10-runtime-integration-handoff.md)                                                                       |

## 当前边界

S3-S8 与 runtime integration R-1-R7 已完成，但 P4/P5 仍只保留长期 backlog，不进入当前 core：CRM、ERP、MES、WMS、商城、支付、会员、多租户、知识库、RAG、Agent 均未实现。S9 OpenForge MVP 尚未开始。
