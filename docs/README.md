...
本目录保存 OpenCore（开元）的架构、模块、开发、策略、handoff 和 AI Native 文档。当前实现状态已经从 S0/S1/S2 推进到 **S3-S8 complete**。
...
| S9    | not_started | [OpenForge 路线图](development/openforge-roadmap.md)                                                                                                       |
...
6. [S3-S8 实现进度](strategy/progress.md)
7. [Handoff 索引](handoff/README.md)
...
| Handoff  | [Handoff 索引](handoff/README.md)、[S3-S8 Implementation Handoff](handoff/2026-06-10-s3-s8-implementation-handoff.md)                                                                                                                                                         |

## 当前边界

S3-S8 已完成，但 P4/P5 仍只保留长期 backlog，不进入当前 core：CRM、ERP、MES、WMS、商城、支付、会员、多租户、知识库、RAG、Agent 均未实现。
