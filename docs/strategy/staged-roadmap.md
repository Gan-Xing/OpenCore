...
本路线图从 S3 开始。S0/S1/D1-D6 已完成文档和 monorepo 基线，S2 已初始化 `apps/api` 和 `apps/admin` 空主干。S3-S9、runtime integration 和 OpenForge V1 A-L 已完成。后续不能跳过 S10 handoff 直接写业务模块。
...
gantt
  ...
  S10 collaboration :s10, after v1, 28d
...
| 第三段 | S8-S10   | 监控、工具、OpenForge V1、消息和 Approval Lite 可演示  |
