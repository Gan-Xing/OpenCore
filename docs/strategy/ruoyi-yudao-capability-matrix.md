...
| System 地区/IP                   | system        | `tool.area` / `integration.ip`                    | tool / integration     | none                             | partial  | P4         | yes               | yes                 | yes                | IP/location provider、GeoIP adapter、Admin visibility 已落地；完整地区库后续准入   |
