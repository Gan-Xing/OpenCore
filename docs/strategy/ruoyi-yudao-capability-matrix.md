...
| -------------------------------- | ------------- | ------------------------------------------------- | ---------------------- | -------------------------------- | -------- | ---------- | ----------------- | ------------------- | ------------------ | ---------------------------------------------------- |
| System 用户管理                  | system        | `core.user`                                       | core                   | NestWeb / Antdpro6               | admin_debt | P1       | yes               | yes                 | yes                | API/SDK 已落地，Admin 仍需去 fixture fallback         |
| System 角色管理                  | system        | `core.role`                                       | core                   | NestWeb / Antdpro6               | admin_debt | P1       | yes               | yes                 | yes                | API/SDK 已落地，Admin 仍需去 fixture fallback         |
...
| System 系统参数                  | system        | `core.config`                                     | core                   | NestWeb / Antdpro6               | admin_debt | P2       | yes               | yes                 | yes                | Runtime/KMS 已落地，Admin 仍需去 fixture fallback     |
...
| System 通知公告                  | system        | `core.notice` / `collaboration.notice`            | core / collaboration   | none                             | admin_debt | P2       | yes               | yes                 | yes                | 通知能力已落地，System Notices Admin 仍需去 fixture fallback |
...
| Infra 文件服务                   | infra         | `core.file`                                       | core / integration     | NestWeb / Antdpro6               | admin_debt | P2       | yes               | yes                 | yes                | 文件 API 已落地，Files Admin 仍需去 fixture fallback  |
| Infra 文件配置                   | infra         | `core.file-config`                                | core / integration     | NestWeb                          | optional | P4         | yes               | yes                 | no                 | 可在文件中心稳定后加入                               |
| Infra 配置管理                   | infra         | `core.config`                                     | core                   | NestWeb / Antdpro6               | admin_debt | P2       | yes               | yes                 | yes                | 与 System 系统参数合并；Admin live-only 仍未关闭     |
