...
本矩阵基于 `/home/ubuntu/dev/ruoyi-vue-pro` 和 `/home/ubuntu/dev/yudao-ui-admin-vue3` 的模块地图，并结合 OpenCore 当前 BE20、Admin Pro V6、Cycle-021 closure、Cycle-022 tenant foundation、NestWeb、Antdpro6 旧项目经验做转译。矩阵用于说明 OpenCore 对若依/芋道能力的归属、优先级和当前完成状态；逐项验收证据以当前 Cycle-022 acceptance/waterline 文档为准，行业深水区仍必须单独准入。
...
| -------------------------------- | ------------- | --------------------------------------------------------- | ---------------------- | -------------------------------- | -------- | ---------- | ----------------- | ------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| System 用户管理                  | system        | `core.user`                                               | core                   | NestWeb / Antdpro6               | done     | P1         | yes               | yes                 | yes                | Cycle-021 已完成 API/SDK/Admin live-only、public smoke 和 deploy guard                                                                                                      |
| System 角色管理                  | system        | `core.role`                                               | core                   | NestWeb / Antdpro6               | done     | P1         | yes               | yes                 | yes                | Cycle-021 已完成 API/SDK/Admin live-only、public smoke 和 deploy guard                                                                                                      |
| System 权限/菜单                 | system        | `core.permission` / `core.menu`                           | core                   | NestWeb / Antdpro6               | done     | P1         | yes               | yes                 | yes                | BE20/Cycle-021 已通过 module-registry/access/live-only guard 约束                                                                                                           |
...
| System 系统参数                  | system        | `core.config`                                             | core                   | NestWeb / Antdpro6               | done     | P2         | yes               | yes                 | yes                | Runtime/KMS/Admin live-only 已落地并通过 Cycle-021 acceptance                                                                                                               |
...
| System 通知公告                  | system        | `core.notice` / `collaboration.notice`                    | core / collaboration   | none                             | done     | P2         | yes               | yes                 | yes                | System Notices Admin 已完成 live management/inbox/template/delivery/outbox 验收                                                                                             |
| System 邮件                      | system        | `integration.mail`                                        | integration            | NestWeb                          | partial  | P4         | yes               | yes                 | yes                | template/outbox/SMTP adapter/Admin 已落地；真实供应商运营面仍需准入                                                                                                         |
| System 短信                      | system        | `integration.sms`                                         | integration            | NestWeb                          | partial  | P4         | yes               | yes                 | yes                | template/outbox/HTTP adapter/Admin 已落地；真实供应商运营面仍需准入                                                                                                         |
| System OAuth2 / SSO              | system        | `integration.oauth`                                       | integration            | none                             | partial  | P4         | yes               | yes                 | yes                | token inventory/detail/revoke 已落地；完整三方 SSO flow 后续准入                                                                                                            |
| System 租户/租户套餐             | system        | `core.tenant` / `core.tenant-plan` / `core.tenant-member` | core                   | none                             | done     | P2         | yes               | yes                 | yes                | Cycle-022 已完成 SaaS tenant foundation V1：tenant identity/auth/data/runtime/Admin control plane、OpenAPI/SDK/smoke/guard 闭环；业务域和生产 SaaS 商业运营扩展仍需单独准入 |
| System 地区/IP                   | system        | `system.area` / `integration.ip`                          | system / integration   | none                             | done     | P2         | yes               | yes                 | yes                | `system.area` 已吸收地区树、AreaCascader、路径格式化、IP 查询、版本化数据集治理、导入 dry-run、Admin/SDK/OpenAPI/smoke/deploy guard；外部商业地区库再单独准入               |
...
| Infra 文件服务                   | infra         | `core.file`                                               | core / integration     | NestWeb / Antdpro6               | done     | P2         | yes               | yes                 | yes                | Files Admin 已完成 list/detail/upload/download/update/delete/export live-only 验收                                                                                          |
| Infra 文件配置                   | infra         | `core.file-config`                                        | core / integration     | NestWeb                          | optional | P4         | yes               | yes                 | no                 | 可在文件中心稳定后加入                                                                                                                                                      |
| Infra 配置管理                   | infra         | `core.config`                                             | core                   | NestWeb / Antdpro6               | done     | P2         | yes               | yes                 | yes                | 与 System 系统参数合并；Admin live-only 已通过 Cycle-021 acceptance                                                                                                         |
...
| Infra WebSocket                  | infra         | `integration.websocket`                                   | integration            | none                             | partial  | P4         | yes               | yes                 | yes                | 已有 runtime diagnostics、连接状态、订阅事件和 Admin 诊断页；不含 IM 聊天                                                                                                   |
...
| 客户经营/线索/商机               | business      | `business.core`                                           | business               | NestWeb / Antdpro6               | done     | P3         | yes               | yes                 | yes                | 作为通用业务底座，走业务路由和业务 API                                                                                                                                      |
