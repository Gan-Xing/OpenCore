export default {
  ...
  'error.INTEGRATION_WEBSOCKET_TENANT_INVALID': 'WebSocket 租户标识无效。',
  ...
  'error.COLLABORATION_TICKET_BOOLEAN_INVALID': '工单布尔查询值无效。',
  'error.COLLABORATION_TICKET_BATCH_EMPTY': '请先选择至少一个工单。',
  'error.COLLABORATION_TICKET_CATEGORY_NOT_FOUND': '工单分类不存在。',
  'error.COLLABORATION_TICKET_DATE_INVALID': '工单日期字段无效。',
  'error.COLLABORATION_TICKET_FIELD_INVALID': '工单字段无效。',
  'error.COLLABORATION_TICKET_FIELD_REQUIRED': '工单必填字段不能为空。',
  'error.COLLABORATION_TICKET_NOT_FOUND': '工单不存在。',
  'error.COLLABORATION_TICKET_PRIORITY_INVALID': '工单优先级无效。',
  'error.COLLABORATION_TICKET_STATUS_INVALID': '工单状态无效。',
  'error.COLLABORATION_TICKET_TRANSITION_INVALID': '工单状态流转无效。',
