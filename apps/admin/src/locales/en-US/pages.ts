export default {
  ...
  'pages.tools.area.actions.activate': 'Activate',
  'pages.tools.area.actions.activateImport': 'Activate area import',
  'pages.tools.area.actions.activateTooltip': 'Activate stored version',
  'pages.tools.area.actions.column': 'Action',
  'pages.tools.area.actions.lookupIpBoundary': 'Lookup IP boundary',
  'pages.tools.area.actions.reload': 'Reload area dataset',
  'pages.tools.area.actions.reloadAria': 'Reload area dataset',
  'pages.tools.area.actions.searchRegions': 'Search regions',
  'pages.tools.area.actions.validateImport': 'Validate area import',
  'pages.tools.area.activate.failure':
    'Unable to activate area dataset version.',
  'pages.tools.area.boolean.no': 'no',
  'pages.tools.area.boolean.yes': 'yes',
  'pages.tools.area.cards.datasetImport': 'Area dataset import',
  'pages.tools.area.cards.datasetVersions': 'Area dataset versions',
  'pages.tools.area.cards.ipBoundaryLookup': 'IP boundary lookup',
  'pages.tools.area.cards.regionQuery': 'Area region query',
  'pages.tools.area.fields.active': 'Active',
  'pages.tools.area.fields.aliases': 'Aliases',
  'pages.tools.area.fields.applied': 'Applied',
  'pages.tools.area.fields.checksum': 'Checksum',
  'pages.tools.area.fields.code': 'Code',
  'pages.tools.area.fields.datasetJson': 'Dataset JSON',
  'pages.tools.area.fields.dryRun': 'Dry run',
  'pages.tools.area.fields.importedAt': 'Imported at',
  'pages.tools.area.fields.ipRanges': 'IP ranges',
  'pages.tools.area.fields.level': 'Level',
  'pages.tools.area.fields.location': 'Location',
  'pages.tools.area.fields.matchedRange': 'Matched range',
  'pages.tools.area.fields.matchedRegion': 'Matched region',
  'pages.tools.area.fields.maxDepth': 'Max depth',
  'pages.tools.area.fields.name': 'Name',
  'pages.tools.area.fields.networkType': 'Network type',
  'pages.tools.area.fields.normalizedIp': 'Normalized IP',
  'pages.tools.area.fields.parent': 'Parent',
  'pages.tools.area.fields.path': 'Path',
  'pages.tools.area.fields.regions': 'Regions',
  'pages.tools.area.fields.source': 'Source',
  'pages.tools.area.fields.version': 'Version',
  'pages.tools.area.fields.warnings': 'Warnings',
  'pages.tools.area.import.failure': 'Unable to import area dataset.',
  'pages.tools.area.load.failure': 'Unable to load area data.',
  'pages.tools.area.load.liveFailure': 'Area data live API unavailable',
  'pages.tools.area.lookup.failure': 'Unable to lookup IP boundary.',
  'pages.tools.area.messages.datasetActivated': 'Area dataset activated.',
  'pages.tools.area.messages.dryRunPassed': 'Area import dry-run passed.',
  'pages.tools.area.messages.versionActivated':
    'Area dataset version activated.',
  'pages.tools.area.permission.importRequired': 'Requires tool:area:import',
  'pages.tools.area.query.failure': 'Unable to query area regions.',
  'pages.tools.area.search.placeholder': 'Search code, name, alias, path',
  'pages.tools.area.section': 'Tool Area',
  'pages.tools.area.stats.activeVersion': 'Active version',
  'pages.tools.area.stats.ipRanges': 'IP ranges',
  'pages.tools.area.stats.maxDepth': 'Max depth',
  'pages.tools.area.stats.regions': 'Regions',
  'pages.tools.area.title': 'Area data boundary',
  'pages.tools.area.validation.datasetJsonRequired':
    'Dataset JSON is required.',
  'pages.tools.area.validation.ipRequired': 'IP is required.',
  'pages.tools.area.versionState.active': 'active',
  'pages.tools.area.versionState.stored': 'stored',
