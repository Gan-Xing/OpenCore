...
export default function access(initialState: InitialState = {}) {
  ...
  return {
    ...
    canReadCrm: hasPermission('industry:crm:read'),
    canCreateCrm: hasPermission('industry:crm:create'),
    canUpdateCrm: hasPermission('industry:crm:update'),
    canAssignCrm: hasPermission('industry:crm:assign'),
    canCommentCrm: hasPermission('industry:crm:comment'),
    canExportCrm: hasPermission('industry:crm:export'),
    canDeleteCrm: hasPermission('industry:crm:delete'),
