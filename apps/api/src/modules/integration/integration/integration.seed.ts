...
export const seedIntegrationProviders: readonly IntegrationProviderRecord[] = [
  ...
  },
  {
    ...
    name: 'Google OAuth',
    enabled: false,
    secretRef: 'secret://config/integration.oauth.google.client-secret.secret',
    secretRefStatus: 'unchecked',
    configVersion: 1,
    config: {
      adapter: 'oauth2',
  ...
  },
  {
    ...
    name: 'WeChat OAuth',
    enabled: false,
    secretRef: 'secret://config/integration.oauth.wechat.client-secret.secret',
    secretRefStatus: 'unchecked',
    configVersion: 1,
    config: {
      adapter: 'oauth2',
  ...
  },
  {
    ...
    name: 'Alipay OAuth',
    enabled: false,
    secretRef: 'secret://config/integration.oauth.alipay.client-secret.secret',
    secretRefStatus: 'unchecked',
    configVersion: 1,
    config: {
      adapter: 'oauth2',
  ...
  },
  {
    ...
    name: 'Douyin OAuth',
    enabled: false,
    secretRef: 'secret://config/integration.oauth.douyin.client-secret.secret',
    secretRefStatus: 'unchecked',
    configVersion: 1,
    config: {
      adapter: 'oauth2',
