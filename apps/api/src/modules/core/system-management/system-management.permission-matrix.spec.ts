...
const expectedPermissions = {
  ...
  deleteDictItems: ['core:dict:delete'],
  deleteDicts: ['core:dict:delete'],
  hardDeleteDict: ['core:dict:delete'],
  hardDeleteDictItem: ['core:dict:delete'],
  ...
  exportDictItems: ['core:dict:export'],
  ...
  getConfigVaultStatus: ['core:config:read'],
  getDept: ['core:dept:read'],
  getDict: ['core:dict:read'],
  getDictItem: ['core:dict:read'],
  getDictImportTemplate: ['core:dict:export'],
  getFile: ['core:file:read'],
  getIpLocationProviderStatus: ['core:login-log:read'],
  ...
  listDeletedDictItemsPage: ['core:dict:read'],
  listDeletedDicts: ['core:dict:read'],
  listDictItemsPage: ['core:dict:read'],
  ...
  lookupIpLocation: ['core:login-log:read'],
  cleanAuditLogs: ['core:audit-log:delete'],
  cleanLoginLogs: ['core:login-log:delete'],
  publishNotice: ['core:notice:update'],
  importDicts: ['core:dict:create'],
  previewImportDicts: ['core:dict:create'],
  refreshConfigCache: ['core:config:update'],
  refreshDictCache: ['core:dict:manage'],
  renderNoticeTemplate: ['core:notice:read'],
  rotateConfigSecret: ['core:config:update'],
  rotateConfigVaultKey: ['core:config:update'],
  restoreDict: ['core:dict:update'],
  restoreDictItem: ['core:dict:update'],
  translateDictValues: ['core:dict:read'],
  ...
  updateDictItemStatus: ['core:dict:update'],
  updateDictStatus: ['core:dict:update'],
