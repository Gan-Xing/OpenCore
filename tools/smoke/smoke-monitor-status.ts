import type { RuntimeResourceSummary } from '@opencore/sdk';
...
async function main() {
  ...
  const status = await clients.monitoring.getStatus(token);
...
function assertRuntimeResources(runtime: RuntimeResourceSummary) {
